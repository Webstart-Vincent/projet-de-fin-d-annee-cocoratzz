...
<body>
    ...
    <header>
        <!-- Logo -->
        <div class="logo">
            <img src="../asset/logo/logo_Bubble_ratzz_account.svg" alt="Logo de Bubble Ratzz pour les parties utilisateurs" />
        </div>
        <!-- Top links -->
        <div class="top-links">
            <a href="../Page_principale/categorie.php">Catégorie</a>
            <a href="../Page_principale/produits.php">Produit</a>
        ...
        <nav>
            <ul>
                ...
                <li><a href="../Page_principale/connexion.php" aria-label="Compte utilisateur"><img src="../asset/picto_account/picto_account-bleu.svg" alt="Icône de compte utilisateur" /></a></li>
            </ul>
        </nav>
    </header>
